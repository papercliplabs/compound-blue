...
import { SwapSide, ContractMethod, OptimalRate } from "@paraswap/sdk";
import { Address, Client, erc20Abi, getAddress, Hex } from "viem";
import { readContract } from "viem/actions";
import { OFFSET_LOOKUP_TABLE, PARASWAP_MAX_PRICE_IMPACT_PCT, paraswapSdk, SUPPORTED_CONTRACT_METHODS } from "./config";

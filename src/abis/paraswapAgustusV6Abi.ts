export const paraswapAgustusV6Abi = [
  {
    inputs: [
      { internalType: "address", name: "_owner", type: "address" },
      { internalType: "address", name: "_diamondCutFacet", type: "address" },
      { internalType: "address", name: "_weth", type: "address" },
      { internalType: "address payable", name: "_balancerVault", type: "address" },
      { internalType: "uint256", name: "_uniV3FactoryAndFF", type: "uint256" },
      { internalType: "uint256", name: "_uniswapV3PoolInitCodeHash", type: "uint256" },
      { internalType: "uint256", name: "_uniswapV2FactoryAndFF", type: "uint256" },
      { internalType: "uint256", name: "_uniswapV2PoolInitCodeHash", type: "uint256" },
      { internalType: "address", name: "_rfq", type: "address" },
      { internalType: "address payable", name: "_feeVault", type: "address" },
  ...
  { stateMutability: "payable", type: "fallback" },
  {
    inputs: [],
    name: "AUGUSTUS_RFQ",
    outputs: [{ internalType: "contract IAugustusRFQ", name: "", type: "address" }],
  ...
  },
  {
    inputs: [],
    name: "FEE_VAULT",
    outputs: [{ internalType: "contract IAugustusFeeVault", name: "", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
  ...
  },
  {
    ...
    outputs: [{ internalType: "bool", name: "isBlacklisted", type: "bool" }],
    stateMutability: "view",
    type: "function",
  },
  {
  ...
  {
    inputs: [{ internalType: "uint256", name: "partnerAndFee", type: "uint256" }],
    ...
    inputs: [
      {
        components: [
          ...
          { internalType: "uint256", name: "quotedAmount", type: "uint256" },
          { internalType: "bytes32", name: "metadata", type: "bytes32" },
          { internalType: "uint256", name: "beneficiaryAndApproveFlag", type: "uint256" },
        ],
    ...
    inputs: [
      {
        components: [
          { internalType: "uint256", name: "fromAmount", type: "uint256" },
          { internalType: "uint256", name: "toAmount", type: "uint256" },
          { internalType: "uint8", name: "wrapApproveDirection", type: "uint8" },
          { internalType: "bytes32", name: "metadata", type: "bytes32" },
          { internalType: "address payable", name: "beneficiary", type: "address" },
        ],
